...
la base de datos creada en PhpMyAdmin y va a crear las tablas necesarias para el funcionamiento del mismo.

El nombre que le debes de dar a la BD (Base de Datos) creada en PhpMyAdmin es: flask
así con minusculas y sin los dos puntos ni espacios y el cotejamiento es: utf8-general-ci
